...
from openeat.modules.swish import Swish
...
def map_to_device(tensor_dict,device):
    ...
    for key, value in tensor_dict.items():
        new_tensor_dict[key] = value.to(device)
...
def th_accuracy(pad_outputs: torch.Tensor, pad_targets: torch.Tensor,
    ...
    """
    # print('pad_outputs',pad_outputs.shape)
    # print('pad_targets', pad_targets.shape)
    pad_pred = pad_outputs.view(pad_targets.size(0), pad_targets.size(1),
                                pad_outputs.size(1)).argmax(-1)
